        ...
        <div className="flex">
          ...
          <div className="relative w-full">
            ...
            onChange={(x) => {setSearchTerm(x.target.value)}}
              type="search"
              id="search-dropdown"
              className=" block p-2.5 w-full z-20 text-xs sm:text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
